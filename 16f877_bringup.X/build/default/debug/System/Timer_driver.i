...
# 10 "System/Timer_driver.c" 2



uint16_t load_count = 64636;
...
static uint32_t timer_cnt_array[5] = {0};

void Timer1_config()
{
# 51 "System/Timer_driver.c"
    PIE1bits.TMR1IE = 0;
...
void Timer0_config()
{
# 86 "System/Timer_driver.c"
}


void __attribute__((inline)) Timer1_isr()
{
